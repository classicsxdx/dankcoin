...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dankcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This coin is powered by LSD";
        CTransaction txNew;
        txNew.nTime = 1401917689;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401917689;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1847045;
		if(fTestNet)
        {
            block.nNonce   = 95532;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x94ba66f74f7bcad0b55b6deceebadcb7989008bd7ffd7d8442c4fb50946c381b"));
        block.print();
